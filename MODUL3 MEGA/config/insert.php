  ...
  $nama_gambar_baru = $angka_acak.'-'.$foto; //menggabungkan angka acak dengan nama file sebenarnya
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {     
                move_uploaded_file($file_tmp, '../dbimg/'.$foto); //memindah file gambar ke folder gambar
                  ...
                  $query = "INSERT INTO showroom_mega_table(nama_mobil, pemilik_mobil, merk_mobil, tanggal_beli, deskripsi, foto_mobil, status_pembayaran)
                  ...
                  if(!$result){
                    ...
                    echo "<script>alert('Data berhasil ditambah.');window.location='../ListCar-Mega.php';</script>";
                  }

            } else {     
             //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                echo "<script>alert('Ekstensi gambar yang boleh hanya jpg atau png.');window.location='../Add-Mega.php';</script>";
            }
} else {
   $query = "INSERT INTO showroom_mega_table(nama_mobil, pemilik_mobil, merk_mobil, tanggal_beli, deskripsi, foto_mobil, status_pembayaran)
