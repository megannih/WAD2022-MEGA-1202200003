  ...
  <body>
    ...
    <div class="container p-5">
        <div class="row vh-100 align-items-center">
            ...
            <!-- COLOM 1 -->
            <div class="col">
                <h2>Selamat datang di showroom Mega</h2>
                <br>
                ...
                <!-- btn -->
                <a href="ListCar-Mega.php" class="btn btn-primary fw-light px-4 py-2">My Car</a>
                <!-- end btn -->
            ...
            <!-- COLOM 2 -->
            <div class="col">
                <img src="asset/brio.jfif" style="width: 400px" alt="">
            </div>
        </div>
    </div>
